...
export default function DrugList({ onSelect, onReload }) {
  ...
  return (
    <section aria-labelledby="med-list-title">
      <h2 id="med-list-title" className="text-xl font-semibold text-gray-900 mb-3">Lista</h2>
          ...
          <li key={d.id} className="flex items-center justify-between rounded border p-3">
            <div>
              ...
              <p className="text-sm text-gray-800">
                {d.startDate || "—"}
                {d.nextIntakeTime ? ` · ${d.nextIntakeTime}` : ""}
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                onClick={async () => {
                  if (confirm(`¿Eliminar ${d.drugName}?`)) {
